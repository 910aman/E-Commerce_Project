...
const Categories = () => {
  ...
  return (
    <>
      <div className="bg-gray-100 mx-auto px-6 text-xs cursor-pointer gap-x-1 gap-y-1 overflow-auto grid grid-cols-2 2xl:grid-cols-7 xl:grid-cols-5 lg:grid-cols-4 sm:grid-cols-2 md:grid-cols-3 py-2">
